...
```{r}
reg <- kernelAggReg(train_design = X[train,],
...
```{r}
reg1 <- kernelAggReg(train_design = X[train,],
                    train_response = y[train],
                    test_design = X[!train,],
...
For how to you the function, see: [https://hassothea.github.io/files/CodesPhD/KernelAggReg.html](https://hassothea.github.io/files/CodesPhD/KernelAggReg.html).
